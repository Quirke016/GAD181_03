...
public static class GameEvents
{
    ...
    public static VoidEventNoPram EndGameCheck;

    public static VoidEventOneParam<Transform> PlayerReachWinCondition;


    /// <summary>
    /// so this one can take in the player transform, and then if they came 1st,second, third etc. 
    /// </summary>
    public static VoidEventTwoParam<Transform, int> PlacementEvent;
